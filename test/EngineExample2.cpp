...
// ----------------------------------------
 ...
 namespace Donut
 {
 	TEngineExample::TEngineExample() : Engine()
 	{
 		...
 		SetVertexShader("shaders/vertex/basicVertexShader.glsl",0);
 		SetFragmentShader("shaders/fragment/basicFragmentShader.glsl",0);
 		
 		DEFAULT_DEBUG_NOARGS("Engine example created");
 	}
